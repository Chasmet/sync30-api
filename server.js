...
const VEED_MAX_SECONDS = 32;

app.get("/", (req, res) => {
  res.json({
    status: "Sync30 API active",
    maxVideo: "Kling 9 sec max / VEED 32 sec max",
    maxAudio: "Kling 9 sec max / VEED 32 sec max",
...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      const maxAllowedSeconds = engine === "kling" ? KLING_MAX_SECONDS : VEED_MAX_SECONDS;
